 ...
 * states.inc.php
 *
 * Streetcar game states description
 *
 */
...
$machinestates = array(
    ...
    10 => array(
        ...
        "type" => "activeplayer",
        "args" => "argPlayerTurn",
        "possibleactions" => array('placeTrack'),
    ...
    14 => array(
        ...
        "transitions" => array("rollDice" => 12, "selectDirection" => 15, "selectDie"=> 13, "nextPlayer"=> 11, "gameEnd" => 99)
    ),
    ...
    15 => array(
        ...
        "possibleactions" => array('selectTrainDirection','doneWithTurn'),
